...
#[derive(Clone)]
pub struct BroadcastHyparviewRun {
    ...
    hyparview_topic: Arc<Topic>,
}

impl BroadcastHyparviewRun {
    pub(super) fn new(shred_version: u16, hyparview_topic: Arc<Topic>) -> Self {
...
impl BroadcastRun for BroadcastHyparviewRun {
    fn run(
        &mut self,
        keypair: &Keypair,
        blockstore: &Blockstore,
...
mod test {
    ...
    fn test_interrupted_slot_last_shred() {
        ...
        let mut run = BroadcastHyparviewRun::new(0);
    ...
    fn test_slot_interrupt() {
        ...
        let mut standard_broadcast_run = BroadcastHyparviewRun::new(0);
